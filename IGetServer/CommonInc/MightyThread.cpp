...
void MightyThread::PostWorkMessage(void * pbuf)
{
	DWORD overLapHandle=0xFFFFFF00;
	::PostQueuedCompletionStatus(m_hQueueCompleteIO,0,reinterpret_cast<DWORD>(pbuf),(LPOVERLAPPED)(&overLapHandle));
}